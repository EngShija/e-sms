        ...
        <div class="row">
	        <div class="col-lg-12">
				<div class="status">
					...
					<h4 class="heading">Payment Purpose Information - </h4>
					<br>
					<p><b>Purpose:</b> <?php echo $itemName; ?></p>
					<p><b>Amount Paid:</b> <?php echo $itemPrice.' '.$currency; ?> ($<?php echo $price;?>.00)</p>
				</div>
