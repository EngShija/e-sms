...
<div class="container">
    <div class="MyLoginForm">
        ...
        <fieldset>
            <legend><img src="images/avatar.jpeg"></legend><br>
            ...
            <form action="./actions-handler/login-handler.php" name="myForm" onsubmit="return FormValidation()"
                ...
                <div class="submit">
                    <input name="login" type="submit" value="login"
                        style="background: blue;  height: font-size: 20px; color: white; border: 2px solid blue; border-radius: 30px; width: 200px;">
                    <br>
                </div>
